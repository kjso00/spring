...
public class ResolverController {
    ...
    @GetMapping("string-redirect")    //html은 대문자 안씀
    public String stringRedirect(){
        return "redirect:/";    //redirect는 사용자의 요청을 처리
    }
    ...
    * 하는 기능을 제공한다.
    ...
    public String stringRdirectFlashAttribute(RedirectAttributes rttr) {
        ...
        * 세션에 임시로 값을 담고 소멸하는 방식이기 대문에 session에 동일한 키값이 존재하지 않아야한다.
         */
        rttr.addAttribute("falshMessage1", "리다이렉트 attr 사용하여 redirect..");
        return "redirect:/";
    }
    ...
    @GetMapping("modeland-redirect-attr")
